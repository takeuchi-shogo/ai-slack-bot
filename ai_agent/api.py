...
from models import MentionRequest, MentionResponse, MentionTask, MentionSource
...
async def handle_mention(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error processing mention: {str(e)}")
...
async def process_directly(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error in direct processing: {str(e)}")
